...
## Anchors within 150 m of a zone boundary (58)
...
- inner-abbotsford-2br (primary): Collingwood College — 111.3 m. Street-level: the zone can flip within the catchment.
- footscray-station-2br (primary): Footscray City Primary School — 59.8 m. Street-level: the zone can flip within the catchment.
- seddon-westfootscray-villa (primary): Footscray City Primary School — 12.0 m. Street-level: the zone can flip within the catchment.
- upfield-corridor (primary): Brunswick North Primary School — 97.7 m. Street-level: the zone can flip within the catchment.
- growth-corridor-stress-test (primary): Baden Powell P-9 College — 4.6 m. Street-level: the zone can flip within the catchment.
- box-hill-2br (primary): Mont Albert Primary School — 86.9 m. Street-level: the zone can flip within the catchment.
- malvern-2br (primary): Caulfield Junior College — 117.8 m. Street-level: the zone can flip within the catchment.
- kew-2br (primary): Kew Primary School — 125.5 m. Street-level: the zone can flip within the catchment.
- cremorne-2br (primary): Richmond Primary School — 51.9 m. Street-level: the zone can flip within the catchment.
- bonbeach-2br (primary): Bonbeach Primary School — 121.2 m. Street-level: the zone can flip within the catchment.
- north-melbourne-2br (primary): North Melbourne Primary School — 51.6 m. Street-level: the zone can flip within the catchment.
...
- fawkner-house (primary): Fawkner Primary School — 25.9 m. Street-level: the zone can flip within the catchment.
- moonee-ponds-2br (primary): Moonee Ponds West Primary School — 126.0 m. Street-level: the zone can flip within the catchment.
- eltham-north-house (primary): Eltham North Primary School — 67.2 m. Street-level: the zone can flip within the catchment.
- braybrook-villa (primary): Sunshine Harvester Primary School — 1.2 m. Street-level: the zone can flip within the catchment.
- bulleen-house (primary): Belle Vue Primary School — 9.8 m. Street-level: the zone can flip within the catchment.
- box-hill-north-house (primary): Kerrimuir Primary School — 80.1 m. Street-level: the zone can flip within the catchment.
- brunswick-west-2br (primary): Brunswick South West Primary School — 87.1 m. Street-level: the zone can flip within the catchment.
...
- caulfield-south-2br (primary): Caulfield South Primary School — 74.3 m. Street-level: the zone can flip within the catchment.
- hillside-house (primary): Hillside Primary School — 112.7 m. Street-level: the zone can flip within the catchment.
- jacana-house (primary): Glenroy West Primary School — 17.9 m. Street-level: the zone can flip within the catchment.
- kings-park-house (primary): Kings Park Primary School — 120.3 m. Street-level: the zone can flip within the catchment.
...
- frankston-middle-ring (secondary): Sandringham College — 78.1 m. Street-level: the zone can flip within the catchment.
- essendon-2br (secondary): Buckley Park College — 143.2 m. Street-level: the zone can flip within the catchment.
...
- albanvale-house (secondary): Copperfield College — 115.4 m. Street-level: the zone can flip within the catchment.
- mill-park-house (secondary): Mill Park Secondary College — 18.7 m. Street-level: the zone can flip within the catchment.

## Anchors with no containing zone (0)

## Zoned schools missing from locations CSV (2)
- Hillside Primary School (hillside-house, primary)
- Ngayuk College (donnybrook-house-land, secondary)

## Unmatched childhood name hints (8)
...
- hillside-house: "Hillside Primary School" (publicPrimary)
