...
| 8   | Community scoring adapters | Yes         | Chinese, grouped other communities and Mingle resolve from compatible raw counts or guarded nulls           | A named measure is null because the official source does not publish enough detail | Averaged percentages, incompatible denominators or direct demographic hand-score        |
...
| 14  | Recreation                 | Yes         | Teen independence follows current rubric; researched sport is blended by existing code; childcare excluded  | Girls' sport absent and existing fallback is used                                  | New formula, double count or unsupported score                                          |
