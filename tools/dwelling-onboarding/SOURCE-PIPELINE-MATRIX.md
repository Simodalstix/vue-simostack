...
app-wide target registry (currently 70 Settle records with IDs, component
...
| Commute, safety, recreation, beach, girls' sport, personal network, facilities | hand-maintained JS records in `src/data/dwelling/` citing `areaSources.js` IDs                                | **Tracked** (except `personalAnchors.local.js`, gitignored)                             | `areaSources.js` is the source registry                                                                                                                            | none (manual, evidence-cited edits)                                                                                                                                   | n/a                                                                                                                                                                                                                                                                 | criteria adapters in `decideStrategies.js`                                               |
