...
What I took from it was the difference between being right and being effective. I went in direct and firm, but I hadn't framed it as a proposal — here's the problem, here's an alternative. I just pushed back. The outcome probably would've been the same, but the conversation wouldn't have ended with him telling me I was being difficult. That's the part I'd do differently.`,
    cues: [
      ...
      'As the pharmacist running the dispensary, I could see it would cause real problems',
      '---',
      'ACTION',
      'Decided to raise it directly — explained my case in writing',
      '1: Register tied up a staff member waiting for payment → often me if working alone',
      '2: Only 2 counter spaces — increased the chance both were occupied → bottleneck compounded',
      '3: Privacy issue — kept customers present while counselling another patient on medication',
      'Card-only: cash payers — the actual theft risk — would just avoid it and go to front registers anyway',
      'Thought I had a solid case.',
      '---',
      'RESULT',
      'He came back: "you\'re the only one causing friction — this isn\'t your decision"',
      'Wasn\'t what I expected. Took time to reflect before I could acknowledge it.',
      'He gives the orders — it\'s his business. I was being asked to implement a decision already made, not give my opinion.',
      'Complied and followed the directive.',
      'Register stayed — workflow issues did happen, slower dispensing, more congestion at the counter',
      'But after raising my concerns clearly, continuing to push would\'ve just damaged the working relationship',
      '---',
      'CLOSE',
      'That situation taught me there\'s a difference between challenging a decision and fighting it',
      'Concerns were valid — but I\'d pushed too hard after the decision had already been made',
      'Now: raise risks early, propose alternatives, then commit once a direction is set',
    ],
