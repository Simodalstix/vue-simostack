...
Found out after that she was a known difficult customer. Reassuring — not for the validation, but because it confirmed the instincts held without knowing that. The password reset was the easy part. What actually mattered was not getting defensive, not pretending to fix things outside my scope, and making sure she felt like someone was paying attention.`,
    cues: [
      ...
      '---',
      'ACTION',
      'Let her explain fully — didn\'t defend the previous tech or debate what happened',
      'Made restoring access the immediate priority — password reset through M365, low risk, fast to test',
      'Access restored during the call',
      'Mid-call: searched the ticketing system unprompted, found the existing audio ticket sitting unresolved — raised it before she had to ask',
      'Escalated directly to the senior engineer with urgency: "she\'s frustrated, she needs a callback today" — not a passive flag',
      'She got a callback within 30 minutes',
      'Followed up with both techs after the call — nobody had to chase me for context',
      '---',
      'RESULT',
      'Access restored during the call — tone shifted once she felt someone was taking ownership',
      'Real frustration was the ignored audio ticket, not the password. Recognising that changed how I handled it.',
      'Second issue had a clear owner and follow-through within 30 minutes',
      '---',
      'CLOSE',
      'Later found out she was a known difficult customer — the instincts held without knowing that',
      'The technical fix was simple. What mattered was composure, ownership, and not letting anything drop',
    ],
...
The easy answer was already available — the other pharmacy gave it. She'd already been failed once. The difference between 'we don't have it' and 'here's why and here's what you do next' was maybe fifteen minutes of my time. That felt like a straightforward call.`,
    cues: [
      ...
      '---',
      'ACTION',
      'Checked AMH, brand and generic databases, dispensing software — nothing. Could have stopped there.',
      'The dispensing answer was already done — confirmed it couldn\'t be filled. What I didn\'t have to do was explain why or find her a path forward.',
      'Kept digging anyway — searched externally, found the drug isn\'t registered in Australia at all',
      'Explained the full situation — overseas practitioner had prescribed something that doesn\'t exist in this market, every pharmacy visit would give her the same answer',
      'Recommended the strongest suitable OTC anti-inflammatory as interim relief while she got the prescription corrected',
      '---',
      'RESULT',
      'She left with a clear explanation, a next step, and something to take the edge off overnight',
      'What started as frustration became a calm interaction once she had clarity and a plan',
      '---',
      'CLOSE',
      'The easy answer already existed — she\'d had it once already. I didn\'t think that was enough.',
      'The difference between "we can\'t help" and "here\'s why and here\'s what you do next" was fifteen minutes of my time',
    ],
