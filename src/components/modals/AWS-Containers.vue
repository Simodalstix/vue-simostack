<template>
  ...
  >
    <div class="bg-slate-900 text-slate-200">
      ...
      <div class="flex flex-col md:flex-row">
        ...
        <div class="md:w-2/3 p-4">
          <img
            ...
            class="object-contain rounded-lg w-full border border-slate-700"
          />
        </div>

        <!-- Slim sidebar: terse, mid-level details -->
        <aside class="md:w-1/3 p-4 space-y-5 md:max-h-[70vh] overflow-y-auto">
          <div class="bg-slate-800/60 border border-slate-700 rounded-md p-4">
            <h3 class="font-semibold text-slate-100 mb-2">EKS — GitOps</h3>
          ...
          <div class="bg-slate-800/60 border border-slate-700 rounded-md p-4">
            <h3 class="font-semibold text-slate-100 mb-2">Fargate — Blue/Green</h3>
            <ul class="text-sm text-slate-300 list-disc list-inside space-y-1">
          ...
          <div class="bg-slate-800/60 border border-slate-700 rounded-md p-3">
            <p class="text-xs text-slate-300">
              <span
                class="mr-2 inline-block px-2 py-0.5 rounded-full border border-slate-600 text-[10px] tracking-wide uppercase text-slate-300"
                >FIS</span
              >
      ...
      <section class="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 border-t border-slate-800">
        <div class="bg-slate-800/60 border border-slate-700 rounded-md p-4">
          <h4 class="font-semibold text-slate-100 mb-2">Observability</h4>
          <ul class="text-sm text-slate-300 list-disc list-inside space-y-1">
        ...
        <div class="bg-slate-800/60 border border-slate-700 rounded-md p-4">
          <h4 class="font-semibold text-slate-100 mb-2">Security</h4>
          <ul class="text-sm text-slate-300 list-disc list-inside space-y-1">
        ...
        <div class="bg-slate-800/60 border border-slate-700 rounded-md p-4">
          <h4 class="font-semibold text-slate-100 mb-2">Links</h4>
          <ul class="text-sm space-y-1">
            <li>
              <a
                class="underline text-slate-300 hover:text-slate-100"
                target="_blank"
