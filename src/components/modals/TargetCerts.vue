    ...
    <div class="space-y-8 mt-6 mx-4">
      ...
      <div class="flex items-center space-x-6 border-b border-slate-600 pb-6">
        ...
        <div class="space-y-2">
          ...
          <p class="text-sm"><b>Status:</b> In study; practice exams underway</p>
          <p class="text-sm">
            <b>Why:</b> Validates pipelines, IaC, automation, monitoring, and ops at scale.
          </p>
          <p class="text-sm">
            <b>Focus:</b> CI/CD on AWS, deployment strategies (blue/green & canary), observability,
            incident response.
          </p>
        </div>
      </div>
      ...
      <div class="flex items-center space-x-6">
        ...
        />
        <div class="space-y-2">
          <h3 class="font-bold text-xl text-white">Azure DevOps Engineer Expert</h3>
          <p class="text-sm"><b>Status:</b> Planned after AWS DevOps Pro</p>
          <p class="text-sm">
            <b>Why:</b> Deepen CI/CD workflows and Azure-native automation experience.
          </p>
        </div>
      </div>
    </div>
